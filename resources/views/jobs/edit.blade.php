<x-layout>
  ...
  <form method="POST" action="/jobs/{{ $job->id }}" class="mt-6 space-y-6">
            ...
            <div class="mt-2">
              <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                <input
                    ...
                    placeholder="Petroleum Technician"
                    required>
              </div>
              <div class="mt-2">
                @error('title')
    ...
    <div class="mt-6 flex items-center justify-between gap-x-6">
      <div class="flex items-center gap-x-3">
        <button type="submit" form="delete-job-form" class="text-sm font-bold leading-6 text-red-500">Delete</button>
      </div>
      <div>
  ...
  <form id="delete-job-form" class="hidden">
  </form>
</x-layout>
